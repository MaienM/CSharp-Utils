...
{
    public class CustomSettingsProvider<T> : SettingsProvider
    {
        ...
        public override string ApplicationName
        {
            get
            {
                return System.Reflection.Assembly.GetEntryAssembly().ManifestModule.Name;
            }
            set
            {
                // Ignore.
        ...
        private void LoadValuesFromFile()
        {
            ...
            var settingElements = configXml.Element(CONFIG).Element(USER_SETTINGS).Element(typeof(T).FullName).Elements(SETTING);
        ...
        private void CreateEmptyConfig()
        {
            ...
            var group = new XElement(typeof(T).FullName);
        ...
        private void SaveValuesToFile()
        {
            ...
            var settingsSection = import.Element(CONFIG).Element(USER_SETTINGS).Element(typeof(T).FullName);
        ...
        private string UserConfigPath
        {
            get
            {
                return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), ConfigName);
                //return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), ApplicationName.Replace(".exe", ".xml"));
            }
        }
        ...
        override public string Name
        {
            get
            {
                return ApplicationName + "-FileSettingsProvider";
            }
        }
